#include "lwpch.h"
#include "ImGuiDarkGreenTheme.h"
#include "imgui/imgui.h"

namespace LWEngine {


	ImGuiDarkGreenTheme::ImGuiDarkGreenTheme()
	{
		m_Name = "Dark-Green Theme";
	}
	bool ImGuiDarkGreenTheme::IsValid()
	{
		return true;
	}

	const char* ImGuiDarkGreenTheme::GetThemeName()
	{
		return m_Name.c_str();
	}

	void ImGuiDarkGreenTheme::SetImGuiTheme(ImGuiStyle& style)
	{
	...
	bool ImGuiDarkGreenTheme::Init()
	{
		return true;
	}

	void ImGuiDarkGreenTheme::Destroy()
	{
	}
}